...
public class RequestHandler implements HttpHandler {
    ...
    private String handlePut(HttpExchange httpExchange) throws IOException {
        ...
        if(data.containsKey(language)) {
            String old = data.get(language);
            response = "Updated entry {" + language + "," + year + "} (previous year:" + old + ")";
        }
        else {
        ...
        // if (language != null) {
        //   String value = query.substring(query.indexOf("=") + 1);
        //   String stuff = data.get(language);
        //   response = "Updated entry {" + value + "," + year + "} (previous year: previousYear)";
        // } else {
        //     response = "Added entry {" + language + "," + year + "}";
        // }
