...
public class HomeController {
    ...
    public void setBackDefault(){
        this.mainPageView.getHeader().getSortDropDown().setValue("New-Old");
        this.mainPageView.getHeader().getFilterDropDown().setValue("AllFilter");
    }
