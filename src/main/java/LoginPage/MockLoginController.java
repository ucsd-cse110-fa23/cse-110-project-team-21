...
public class MockLoginController {
  ...
  public MockLoginController(boolean isServerUp) {
        isServer = isServerUp;

        if(isServer){
            String url = Main.HOSTNAME_URL;
            result = "Connection established";
            isServer = true;
        }else{
            result = 
            "Alert: " + showAlert("Server Down Error", "Server could not be connected. Please try again later.");
        }
  ...
  public String showAlert(String title, String message) {
    return message;
  }
