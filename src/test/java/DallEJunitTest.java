...
public class DallEJunitTest {
    ...
    void testRequestingImageExistTitle(){
        ...
        RecipeModel recipe = new RecipeModel("Tomato, Onion, and Bread Casserole", ""); 
        String previewImgFileName = dallE.performImageRequest(recipe.getTitle().replace(" ", "%20"), mockDirectory);
        assertEquals(previewImgFileName,"=Tomato,%20Onion,%20and%20Bread%20Casserole.jpg [already existed]");
